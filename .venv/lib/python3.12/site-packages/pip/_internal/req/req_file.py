...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_internal/req/req_file.py
        self,
        filename: str,
        constraint: bool,
...
=======
        self, filename: str, constraint: bool
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_internal/req/req_file.py
    ) -> Generator[ParsedLine, None, None]:
