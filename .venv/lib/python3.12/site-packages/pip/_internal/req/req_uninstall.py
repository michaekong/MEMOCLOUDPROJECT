...
def uninstallation_paths(dist: BaseDistribution) -> Generator[str, None, None]:
    ...
    if entries is None:
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_internal/req/req_uninstall.py
...
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_internal/req/req_uninstall.py
