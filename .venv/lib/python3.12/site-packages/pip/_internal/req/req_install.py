...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_internal/req/req_install.py
            deprecated(
                reason=(
...
=======
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_internal/req/req_install.py
            if self.config_settings:
                logger.warning(
