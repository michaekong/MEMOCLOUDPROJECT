    ...
    try:
        ...
        try:
            ...
            def pip_filter(member: tarfile.TarInfo, path: str) -> tarfile.TarInfo:
                ...
                try:
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_internal/utils/unpacking.py
                    try:
...
=======
                    ...
                    logger.warning(
                        ...
                        member.name,
                        exc,
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_internal/utils/unpacking.py
                    )
