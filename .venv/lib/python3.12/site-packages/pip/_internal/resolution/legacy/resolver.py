...
class Resolver(BaseResolver):
    ...
    def _add_requirement_to_set(
        ...
        try:
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_internal/resolution/legacy/resolver.py
...
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_internal/resolution/legacy/resolver.py
        except KeyError:
            existing_req = None
