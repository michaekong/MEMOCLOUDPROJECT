...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/truststore/_macos.py
_is_macos_version_10_14_or_later = _mac_version_info >= (10, 14)

=======
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/truststore/_macos.py
