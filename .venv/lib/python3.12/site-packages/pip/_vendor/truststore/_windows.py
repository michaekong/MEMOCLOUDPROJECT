...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/truststore/_windows.py
SECURITY_FLAG_IGNORE_CERT_CN_INVALID = 0x00001000
=======
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/truststore/_windows.py
AUTHTYPE_SERVER = 2
