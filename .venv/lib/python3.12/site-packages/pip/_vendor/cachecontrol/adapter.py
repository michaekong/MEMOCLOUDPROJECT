...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/cachecontrol/adapter.py
                response._fp = CallbackFileWrapper(  # type: ignore[assignment]
                    response._fp,  # type: ignore[arg-type]
=======
                response._fp = CallbackFileWrapper(  # type: ignore[attr-defined]
                    response._fp,  # type: ignore[attr-defined]
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/cachecontrol/adapter.py
                    functools.partial(
                        self.controller.cache_response, request, response
                    ),
                )
