...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/rich/pretty.py
    try:
...
=======
    if "get_ipython" in globals():
        ip = get_ipython()  # type: ignore[name-defined]
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/rich/pretty.py
