...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/distlib/util.py
...
from .compat import (string_types, text_type, shutil, raw_input, StringIO,
                     ...
                     unquote, urlparse)
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/distlib/util.py
