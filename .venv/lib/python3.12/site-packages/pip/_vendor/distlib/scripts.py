...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/distlib/scripts.py
...
=======
    def __init__(self,
                 ...
                 dry_run=False,
                 fileop=None):
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/distlib/scripts.py
