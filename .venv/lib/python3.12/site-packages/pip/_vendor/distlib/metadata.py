...
<<<<<<< HEAD:micaenv/lib/python3.10/site-packages/pip/_vendor/distlib/metadata.py
        # possible_versions.remove('2.0')
        # logger.debug('Removed 2.0 due to %s', key)
=======
            # possible_versions.remove('2.0')
            # logger.debug('Removed 2.0 due to %s', key)
>>>>>>> 6a1e6e03 (Sauvegarde de mes modifications avant la fusion):.venv/lib/python3.12/site-packages/pip/_vendor/distlib/metadata.py
